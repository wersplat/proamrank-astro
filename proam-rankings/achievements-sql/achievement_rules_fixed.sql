-- Fixed Achievement Rules for all 45 achievements
-- This version handles the exact achievement names from the database

-- Clear any existing rules first (optional)
...
('Efficiency King', 'epic', 'per_game', '{"and": [{"per_game.fga": {"gte": 15}}, {"per_game.fgm": {"gte": 10}}]}', true),
...
-- Season Achievements (simplified predicates)
INSERT INTO public.achievement_rules (name, tier, scope, predicate, is_active) VALUES
('10+ APG', 'legendary', 'season', '{"season.ast_avg": {"gte": 10}}', true),
('Board Leader', 'legendary', 'season', '{"season.reb_avg": {"gte": 15}}', true),
('Season Stealer', 'legendary', 'season', '{"season.stl_avg": {"gte": 3}}', true),
('Season Swatter', 'legendary', 'season', '{"season.blk_avg": {"gte": 3}}', true),
...
('Consistency Award', 'epic', 'season', '{"and": [{"season.pts_avg": {"gte": 15}}, {"season.reb_avg": {"gte": 5}}, {"season.ast_avg": {"gte": 5}}]}', true);

-- Defense Achievements
INSERT INTO public.achievement_rules (name, tier, scope, predicate, is_active) VALUES
('Clamps', 'rare', 'per_game', '{"per_game.points_allowed": {"lt": 5}}', true);

-- Legendary Achievements (Special Cases) - Note: "Carry Job" has a newline character
INSERT INTO public.achievement_rules (name, tier, scope, predicate, is_active) VALUES
('Carry Job
