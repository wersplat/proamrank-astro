...
export default function TournamentTabsIsland({
  ...
  // Get placement color
  const getPlacementColor = (placement: number | undefined) => {
    if (!placement) return '';
            ...
            {tournamentInfo ? (
              <>
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  {tournamentInfo.prize_pool && (
                    <div>
                      <div className="text-sm text-neutral-400 mb-1">
                        Prize Pool
                      </div>
                      <div className="text-lg font-semibold text-green-400">
                        ${tournamentInfo.prize_pool.toLocaleString()}
                      </div>
                    </div>
                  )}
                  {tournamentInfo.max_rp && (
                    <div>
                      <div className="text-sm text-neutral-400 mb-1">Max RP</div>
