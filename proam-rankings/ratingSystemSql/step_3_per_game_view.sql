-- STEP 3: Create per-game performance view
-- This calculates weighted performance for each game
...
-- Test query
SELECT COUNT(*) as game_count, COUNT(DISTINCT player_id) as player_count
