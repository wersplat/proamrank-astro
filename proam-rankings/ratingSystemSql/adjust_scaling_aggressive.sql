-- ============================================================================
-- OPTION 2: MORE AGGRESSIVE SCALING
-- Use this if Option 1 still doesn't get top players to 90+
-- This will push elite players into 95-100+ range
-- ============================================================================

-- Change game impact to allow up to 40 points (instead of 30)
-- Change scaling from /3.0 to /2.0 for more generous scoring
...
SELECT 
  ...
  weight_multiplier,
  tier_bonus,
  -- VERY AGGRESSIVE: Divide by 2.0 and cap at 40
  -- This will definitely get top players to 95+
  GREATEST(0, LEAST(40, 
    (raw_score / 2.0) * COALESCE(weight_multiplier, 1.0)
